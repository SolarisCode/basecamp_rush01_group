...
/*   Updated: 2021/10/10 00:41:04 by ckonstan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

void	set_col_for_hint_1(int row, int col, int playground[6][6])
{
	int hint;
...
void	set_row_for_hint_1(int row, int col, int playground[6][6])
{
	int hint;
